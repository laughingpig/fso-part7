...
describe('Total likes', () =>{
  test('of empty licontains an idst is zero', () => {
...
describe('Favourite blog', () => {
  ...
  test('when list has only one blog, same blog', () => {
...
describe('Most blogs', () => {
  ...
  test('when list has only one blog, the blog with count', () => {
...
describe('Most likes', () => {
  ...
  test('when list has only one blog, the blog with likes', () => {
